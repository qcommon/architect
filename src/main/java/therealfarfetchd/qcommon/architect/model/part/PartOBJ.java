...
import therealfarfetchd.qcommon.architect.loader.obj.OBJPartBuilder.MatDef;
...
public class PartOBJ implements Part {
    ...
    private final Map<String, MatDef> materials;
...
//    }
    ...
    public PartOBJ(Map<String, MatDef> materials) {
